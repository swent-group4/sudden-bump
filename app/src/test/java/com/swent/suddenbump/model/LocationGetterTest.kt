...
class LocationGetterTest {
    ...
    fun setUp() {
        ...
        listener = object : LocationGetter.LocationListener {
    ...
    fun requestLocationUpdates_permissionGranted_requestsLocationUpdates() {
        ShadowApplication.getInstance().grantPermissions(android.Manifest.permission.ACCESS_FINE_LOCATION)
    ...
    fun requestLocationUpdates_permissionDenied_callsOnLocationFailure() {
        ShadowApplication.getInstance().denyPermissions(android.Manifest.permission.ACCESS_FINE_LOCATION)
