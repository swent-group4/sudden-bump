...
class TestMeetingRepository : MeetingRepository {
    ...
    override fun updateMeeting(meeting: Meeting, onSuccess: () -> Unit, onFailure: (Exception) -> Unit) {
    ...
    override fun deleteMeetingById(id: String, onSuccess: () -> Unit, onFailure: (Exception) -> Unit) {
