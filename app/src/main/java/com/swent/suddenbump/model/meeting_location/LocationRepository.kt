 ...
 *
 * Implementations of this interface are responsible for performing location searches and returning
 * the results or handling errors accordingly.
 */
interface LocationRepository {
   ...
   * @param onSuccess A callback invoked with a list of [Location] objects when the search is
   *   successful.
