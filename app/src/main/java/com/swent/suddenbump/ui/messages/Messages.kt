...
data class Message(val sender: String, val content: String, val date: String)
...
fun MessagesScreen(navigationActions: NavigationActions) {
  val messages =
      listOf(
          Message(
              "Gérard Barel",
              "Hi Marc! Thanks for your message, I'd love to go for a drink! Let's say 9pm?",
              "11/05/2024, 11:54"),
          Message(
              "Clarisse Biquet",
              "Hi Marc! Thanks for your message, I'd love to go for a drink! Let's say 9pm?",
  ...
  Scaffold(
      ...
      bottomBar = {
        ...
        LazyColumn(
            modifier = Modifier.padding(padding).background(Color.Black).testTag("messages_list")) {
...
fun MessageItem(message: Message) {
  Row(
      modifier =
        ...
        Image(
            painter =
                painterResource(R.drawable.profile), // Utilise une icône de ressource pour l'avatar
