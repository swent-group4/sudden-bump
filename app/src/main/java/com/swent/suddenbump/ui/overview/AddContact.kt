...
fun generateMockUsers(): List<User> {
    val firstNames = listOf("John", "Jane", "Alice", "Bob", "Charlie", "David", "Eve", "Frank", "Grace", "Hank")
    val lastNames = listOf("Doe", "Smith", "Johnson", "Williams", "Brown", "Jones", "Garcia", "Miller", "Davis", "Rodriguez")
    val birthDates = listOf("01 Janvier 2002", "28 Juin 1998", "15 Mars 1995", "22 Avril 1990", "30 Mai 1985", "10 Juillet 1980", "05 Août 1975", "12 Septembre 1970", "18 Octobre 1965", "25 Novembre 1960")
...
fun AddContactScreen(navigationActions: NavigationActions) {
  ...
  Scaffold(
      ...
      content = { pd -> Column(modifier=Modifier.padding(pd), horizontalAlignment = Alignment.CenterHorizontally) {
          TextField(
              value = searchQuery,
