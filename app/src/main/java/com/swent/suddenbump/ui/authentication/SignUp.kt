        ...
        content = { paddingValues ->
            Column(modifier = Modifier.fillMaxSize().padding(paddingValues)) {
                ...
                Button(
                    onClick = {
                        val profileBitmap =
                            if (profilePictureUri != null) {
                                ...
                                val defaultUri = Uri.parse("android.resource://${context.packageName}/raw/profile")
                    ...
                    enabled = firstName.isNotBlank() && lastName.isNotBlank() && email.isNotBlank() && phoneNumber.isNotBlank() && verificationStatus == "Phone Verified",
